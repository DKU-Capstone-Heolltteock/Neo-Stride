...
public class MyFeedAdapter extends RecyclerView.Adapter<MyFeedAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if (holder.tvTime != null) {
            holder.tvTime.setText(com.neostride.app.feature.community.common.util.TimeFormatter.format(item.createdAt));
        }
    ...
    private void confirmAndDeleteFeed(Context ctx, CommunityContentResponse item, int position) {
        com.neostride.app.feature.community.common.util.DangerConfirmDialog.show(
            ...
            () -> new com.neostride.app.feature.feed.repository.FeedRepository(ctx)
                .deleteFeed((long) item.contentId,
                    new com.neostride.app.feature.feed.repository.FeedRepository.RepositoryCallback<Boolean>() {
