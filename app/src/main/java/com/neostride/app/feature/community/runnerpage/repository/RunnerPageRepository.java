package com.neostride.app.feature.community.runnerpage.repository;
...
import com.neostride.app.feature.community.runnerpage.api.RunnerPageService;
...
public class RunnerPageRepository {
    ...
    // 러너 팁 목록을 조회해 Retrofit Callback으로 반환
    public void getRunnerTips(int userId, Callback<List<TipResponse>> callback) {
        apiService.getRunnerTips(userId).enqueue(callback);
    }
