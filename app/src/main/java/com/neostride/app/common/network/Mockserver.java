...
public class Mockserver implements Interceptor {
    ...
    public Response intercept(Chain chain) throws IOException {
        ...
        // [로그인] POST /api/auth/login — 어떤 계정이든 mock 토큰으로 성공 처리
        if (method.equals("POST") && uri.contains("auth/login")) {
            String json = "{\n" +
                    "  \"status\": \"success\",\n" +
                    "  \"message\": \"로그인 성공\",\n" +
                    "  \"user_id\": 100,\n" +
                    "  \"email\": \"youngjaejang123@gmail.com\",\n" +
                    "  \"name\": \"장영재\",\n" +
        ...
        // GET /api/community/feeds/{id}/tagged-users — 피드 태그된 사용자 목록
        // 반드시 community/feeds/\d+ 상세 조회보다 먼저 체크해야 함
        if (method.equals("GET") && uri.matches(".*community/feeds/\\d+/tagged-users.*")) {
            String json = "[\n" +
                    "  {\n" +
                    "    \"user_id\": 42,\n" +
                    ...
                    "    \"badge_tier\": \"gold\",\n" +
                    "    \"friend_count\": 14,\n" +
                    "    \"profile_image_url\": \"https://picsum.photos/seed/user42/100/100\",\n" +
                    "    \"status\": \"ACCEPTED\"\n" +
                    "  },\n" +
                    "  {\n" +
                    "    \"user_id\": 43,\n" +
        ...
        if (method.equals("GET") && uri.contains("community/feeds")) {
            String json = "[\n" +
                    ...
                    "    \"liked\": false, \"bookmarked\": false, \"commented\": true, \"tagged\": true, \"mine\": false\n" +
                    "  },\n" +
                    "  {\n" +
        ...
        if (method.equals("GET") && uri.matches(".*community/tips/\\d+.*")) {
            ...
            String json = "{\n" +
                    ...
                    "  \"writerId\": 45,\n" +
                    "  \"nickname\": \"MaraFan\",\n" +
                    "  \"profileImageUrl\": \"https://picsum.photos/100/320\",\n" +
                    "  \"badgeOwned\": true,\n" +
                    "  \"badgeType\": \"platinum\",\n" +
                    "  \"category\": \"코스\",\n" +
                    "  \"title\": \"단국대 죽전로 야경 코스 추천\",\n" +
                    "  \"content\": \"단국대 정문에서 출발해서 죽전로 한 바퀴 도는 5km 코스 진짜 좋아요. 가로등도 충분하고 안전합니다. 밤 9시 이후에 달리면 차도 거의 없어서 쾌적하게 달릴 수 있어요. 오르막이 살짝 있어서 훈련용으로도 딱 좋습니다.\",\n" +
                    "  \"gpsVisible\": true,\n" +
                    "  \"routeMapImageUrl\": \"https://picsum.photos/seed/route31/600/400\",\n" +
                    "  \"courseAddress\": \"경기 용인시 수지구 죽전로 52 (단국대학교 정문 인근)\",\n" +
                    "  \"imageUrls\": [\"https://picsum.photos/seed/tip31a/600/600\", \"https://picsum.photos/seed/tip31b/600/600\"],\n" +
                    "  \"likeCount\": 38,\n" +
                    "  \"commentCount\": 4,\n" +
                    "  \"liked\": false,\n" +
                    "  \"bookmarked\": false,\n" +
                    ...
                    "  \"comments\": [\n" +
                    "    {\"commentId\": 1, \"writerId\": 42, \"nickname\": \"MorningPace\", \"profileImageUrl\": \"https://picsum.photos/100/301\", \"badgeOwned\": true, \"badgeType\": \"gold\", \"content\": \"저도 이 코스 자주 달려요! 야경 진짜 예쁘죠\", \"createdAt\": \"2026-05-13T19:45:00\", \"mine\": false},\n" +
                    "    {\"commentId\": 2, \"writerId\": 43, \"nickname\": \"TrailWalker\", \"profileImageUrl\": null, \"badgeOwned\": true, \"badgeType\": \"bronze\", \"content\": \"오르막 구간이 어디서부터인가요?\", \"createdAt\": \"2026-05-13T20:10:00\", \"mine\": false},\n" +
                    "    {\"commentId\": 3, \"writerId\": 100, \"nickname\": \"MocktestID1557\", \"profileImageUrl\": null, \"badgeOwned\": true, \"badgeType\": \"platinum\", \"content\": \"다음 주말에 한번 달려봐야겠네요\", \"createdAt\": \"2026-05-14T08:00:00\", \"mine\": true},\n" +
                    "    {\"commentId\": 4, \"writerId\": 44, \"nickname\": \"NightRun77\", \"profileImageUrl\": \"https://picsum.photos/100/302\", \"badgeOwned\": false, \"badgeType\": null, \"content\": \"주차는 어디에 하셨나요?\", \"createdAt\": \"2026-05-14T09:30:00\", \"mine\": false}\n" +
                    "  ]\n" +
                    "}";
            return buildResponse(chain, json);
        }
        ...
        if (method.equals("GET") && uri.contains("community/tips")) {
            String json = "[\n" +
                    ...
                    "    \"gpsVisible\": true, \"routeMapImageUrl\": \"https://picsum.photos/seed/route31/600/400\",\n" +
                    "    \"imageUrls\": [\"https://picsum.photos/seed/tip31a/600/600\"],\n" +
        ...
        if (method.equals("GET") && uri.contains("api/notifications")) {
            String json = "[\n" +
                    "  {\n" +
                    "    \"notificationId\": 1,\n" +
                    "    \"type\": \"FEED_TAG\",\n" +
                    "    \"message\": \"러너킹님이 피드에서 회원님을 태그했습니다\",\n" +
                    ...
                    "    \"notificationId\": 3,\n" +
                    "    \"type\": \"GRADE\",\n" +
                    "    \"message\": \"축하합니다! 실버 러너 등급을 달성했습니다\",\n" +
                    ...
                    "    \"notificationId\": 4,\n" +
                    "    \"type\": \"FEED_COMMENT\",\n" +
                    "    \"message\": \"마라토너K님이 회원님의 피드에 댓글을 달았습니다\",\n" +
                    "    \"createdAt\": \"2026-05-18T15:22:00\",\n" +
                    "    \"targetId\": 55,\n" +
                    "    \"read\": true\n" +
                    "  },\n" +
                    "  {\n" +
                    "    \"notificationId\": 5,\n" +
                    "    \"type\": \"TIP_LIKE\",\n" +
                    "    \"message\": \"조깅마스터님이 회원님의 팁에 좋아요를 눌렀습니다\",\n" +
                    ...
                    "    \"notificationId\": 6,\n" +
                    "    \"type\": \"TIP_COMMENT\",\n" +
                    "    \"message\": \"달리기고수님이 회원님의 팁에 댓글을 달았습니다\",\n" +
                    ...
                    "    \"notificationId\": 7,\n" +
                    "    \"type\": \"FEED_TAG\",\n" +
                    "    \"message\": \"스피드퀸님이 피드에서 회원님을 태그했습니다\",\n" +
